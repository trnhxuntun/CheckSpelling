...
class DatnGui1App:
    def __init__(self, master, maingui):
        ...
        self.lb_Find.configure(anchor='n', compound='top', font='TkTextFont', text='Find:')
        ...
        self.lb_Replace.configure(anchor='n', compound='top', font='TkTextFont', text='Replace with:')
        ...
        self.btnReplace.configure(text='Replace all')
    ...
    def find_text(self):
        ...
        for val in content.split('\n'):
            ...
            line += 1
        self.lb_Message.config(text='Found %s item(s)' % str(count))
    ...
    def replace_text(self):
        ...
        self.lb_Message.config(text='Replaced successfully')
